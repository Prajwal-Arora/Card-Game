...
const CreateRoom = () => {
    ...
    return (
        <div className="w-75 m-auto position-relative d-grid justify-content-center overflow-hidden" style={{height:'85vh'}}>
            <div className="d-flex">
                <img className="w-50 m-auto" src="/images/Logo-golden 2.png" alt="" />
            </div>
            <div style={{ bottom: '85px' }} className="position-relative z-0">
                <img style={{ width: '60%' }} className="m-auto d-flex" src="/images/Logo-golden2 1.png" alt="" />
                    ...
                    {!walletState?.accounts[0] ? (
                        ...
                        <div className="d-grid m-auto w-50">
                            ...
                            <Link className="text-decoration-none"
                                ...
                                <button className="custom-btn mt-2 focus:outline-none w-100">Battle History</button>
                            </Link>
